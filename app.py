...
st.write("Sube una imagen con resultados y genera archivos CSV + SQL automáticamente.")
...
if uploaded_file:
    ...
    if st.button("Guardar como CSV y SQL"):
        # Simulación de datos extraídos (puedes cambiar esto luego para analizar el texto_extraido)
        data = [
